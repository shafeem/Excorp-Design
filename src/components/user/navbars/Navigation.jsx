...
const Navigation = () => {
  const Menus = [
    ...
    { name: "Interiors", icon: "person-outline", dis: "translate-x-16" },
    { name: "Design", icon:e"chatbubble-outline", dis: "translate-x-32" },
    { name: "About", icon: "camera-outline", dis: "translate-x-48" },
    // { name: "Settings", icon: "settings-outline", dis: "translate-x-64" },
  ];
  const [active, setActive] = useState(0);
  return (
    // max-h-[4.4rem]
    <div className="w-screen px-14 rounded-t-xl bg-gray-400">
